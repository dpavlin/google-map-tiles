...
# Google_Pix_to_Coord				# Calculate Pixels to coordinates
...
sub Google_Tile_Calc
{
 ...
 ($result{'LATN'},$result{'LNGW'}) = &Google_Pix_to_Coord( $value, $result{'PYN'}, $result{'PXW'} ) ;
 ...
 ($result{'LATS'},$result{'LNGE'}) = &Google_Pix_to_Coord( $value, $result{'PYS'}, $result{'PXE'} ) ;
...
# Calculate a tile name from a pixel location and zoom: Externally called version...
...
# Translate a pixel location to a tile name: Internally called version...
